...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = [run].map(_regenerator2.default.mark);
	...
	function run() {
	    var story, chapterPromises, i, chapterPromise, chapter;
	        ...
	        while (1) {
	            switch (_context.prev = _context.next) {
	                ...
	                case 2:
	                    ...
	                    chapterPromises = story.chapterUrls.map(function (chapterUrl) {
	                        return request('../../data/' + chapterUrl);
	                    });
	                    i = 0;
	
	                case 6:
	                    if (!(chapterPromise = chapterPromises[i])) {
	                        _context.next = 14;
	                        break;
	                    }
