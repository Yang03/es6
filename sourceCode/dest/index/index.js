...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applyMiddleware = __webpack_require__(78);
	
	var _applyMiddleware2 = _interopRequireDefault(_applyMiddleware);
	
	var _thunk = __webpack_require__(86);
	...
	function count() {
	    ...
	    switch (action.type) {
	        case 'add':
	            return (0, _assign2.default)({}, state, { count: action.count + 1 });
	            break;
	        case 'decrease':
	            return (0, _assign2.default)({}, state, { count: action.count - 1 });
	            break;
	...
	var store = (0, _createStore.createStore)(count);
	
	// store.subscribe(function () {
	//   console.log('count: ', store.getState().count);
	// })
	//
	var action = { type: 'add', count: 1 };
	...
	var asyncStore = (0, _createStore.createStore)(count, (0, _applyMiddleware2.default)(_thunk2.default));
	...
	*/
	asyncStore.dispatch(addAsync()).then(function () {
	...
	function applyMiddleware() {
	    ...
	    return function (createStore) {
	        return function (reducer, preloadedState, enhancer) {
	             ...
	             */
	            _dispatch = _compose2.default.apply(undefined, (0, _toConsumableArray3.default)(chain))(store.dispatch);
